...
| 🛡️ **Secure Authentication** | PIN-based security system |
...
> ⚠️ **Important**: Currently, only **Gemma-3-1B-IT** is fully functional and recommended for use.
...
```mermaid
graph LR
    A[🔌 Insert USB] --> B[▶️ Run Launcher]
    B --> C[🎯 Select Interface]
    C --> D[🤖 Start Chatting!]
    style A fill:#e1f5fe
    style B fill:#fff3e0
    style C fill:#f3e5f5
...
1️⃣ **Insert** the USB drive (mounts as E:)
